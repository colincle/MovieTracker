...
class TestTitleCard : public QObject
{
  ...
  private:
    ...
    static IconTextButton *toWatchButton(TitleCard &card) { return textButtons(card).at(0); }
    static IconTextButton *watchedButton(TitleCard &card) { return textButtons(card).at(1); }
...
QObject *createTestTitleCard() { return new TestTitleCard(); }
