...
class TestLevenshtein : public QObject
{
  ...
  private slots:
    ...
    void classicKittenSittingIsThree()
    {
        QCOMPARE(levenshtein("kitten", "sitting"), 3);
    }
    ...
    void emptyFieldDoesNotMatch()
    {
        QVERIFY(!levenshteinMatches("hello", ""));
    }
};

#include "TestLevenshtein.moc"

QObject *createTestLevenshtein() { return new TestLevenshtein(); }
